...
model = load_model('GRL@Tiny')  # You can Change the model name to load different models
...
interpolated_grad_numpy, result_numpy, interpolated_numpy = Path_gradient(tensor_lr.cpu().numpy(), model, attr_objective, gaus_blur_path_func, cuda=cuda_available)
